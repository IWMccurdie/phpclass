...
<div class="content-section-b">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12" <?=$error_styles;?>></div>
            <?php
        ...
        <div class="row">
            <div class="col-sm-6">
                <h2>Login</h2>
                <?php
                    echo form_open('http://10.7.66.28/marathon/public/login');
            ...
            <div class="col-sm-6">
                ...
                <?php
                    echo form_open('http://10.7.66.28/marathon/public/create');
                    echo form_input('username', '', 'placeholder="Username"');
                    echo form_password('password', '', 'placeholder="Password"');
